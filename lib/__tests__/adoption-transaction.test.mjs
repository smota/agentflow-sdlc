...
describe('preview-first transactional adoption', () => {
  ...
  it('fails closed on an unknown future lockfile version', () => {
    ...
    expect(() => planAdoption(packageRoot, target)).toThrow('unknown lockfile version')
  })
  ...
  it('auto-generates an external receipt in OS temp directory when receiptDestination is omitted', () => {
    const plan = planAdoption(packageRoot, target)
