...
/**
 * Extract and parse the first ```json fenced code block within a section body (as returned by
 * `extractSection`). Returns null when no section text was given, no fenced block is present, or
 * the block does not parse as JSON.
 */
export function extractJsonBlock(section) {
  if (!section) {
    return null
  }
