...
// AGENTS.md or docs/stack-conventions.md seeded automatically — copy them from this package by hand
// in that case. See https://github.com/smota/multi-agent-sdlc/issues (filed as a follow-up).
