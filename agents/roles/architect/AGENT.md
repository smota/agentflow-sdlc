...
Choose workflow profile, strategy, risks, boundaries, and SDD.

## Activation triggers

- The AgentFlow phase model selects `architect`.
- A collaboration plan delegates a bounded architect perspective.
- A human explicitly requests architect analysis.
...
Do not write implementation code or claim validation.
