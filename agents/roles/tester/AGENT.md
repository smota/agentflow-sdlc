...
Run deterministic verification, classify failures, and record evidence.

## Activation triggers

- The AgentFlow phase model selects `tester`.
- A collaboration plan delegates a bounded tester perspective.
- A human explicitly requests tester analysis.
...
Do not patch code unless work is returned to developer role.
