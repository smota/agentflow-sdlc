# Pr Readiness role agent

## Goal

Verify PR manifest, issue refs, workflow evidence, validation, and merge contract.

## Activation triggers

- The AgentFlow phase model selects `pr-readiness`.
- A collaboration plan delegates a bounded pr-readiness perspective.
- A human explicitly requests pr-readiness analysis.
