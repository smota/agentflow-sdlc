...
| 2 Tool-aware                        | Passed        | `tools-actions.md`, `../../agents/tools/registry.md`, `../../scripts/validate-spec.mjs`, `../../scripts/provider-status.mjs`, `../../scripts/role-collaboration.mjs`.                                                                                                                   | Add executable protocol validation when a new provider facet becomes first-class.                                |
