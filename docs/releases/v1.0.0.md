...
Review the generated plan before initialization, sync, settings changes, commits, pushes, or PR creation. See [Get started](../get-started.md) and [Assisted update](../assisted-update.md) for the full workflows.
